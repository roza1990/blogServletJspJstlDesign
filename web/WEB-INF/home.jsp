        ...
        <div class="container logo-wrap">
            <div class="row pt-5">
                <div class="col-12 text-center">
                    ...
                    <h1 class="site-logo"><a href="/home">Blog</a></h1>
                </div>
            </div>
        </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown05">
                                <c:forEach items="${categories}" var="category">
                                    <a class="dropdown-item" href="/home?categoryId=${category.id}">${category.name}</a>
                                </c:forEach>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="owl-carousel owl-theme home-slider">
                        <c:forEach items="${posts}" var="post">
                            <div>
                                <a href="/singlePost?id=${post.id}" class="a-block d-flex align-items-center height-lg"
                                   style="background-image: url('/getImage?picName=${post.picUrl}'); ">
                                    <div class="text half-to-full">
                                        ...
                                        <div class="post-meta">
                                            ...
                                            <span class="mr-2">${post.createdDate} </span> &bullet;
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    <div class="row">
                        ...
                        <c:forEach var="post" items="${requestScope.get('posts')}">
                            <div class="col-md-6">
                                <a href="/singlePost?id=${post.id}" class="blog-entry element-animate" data-animate-effect="fadeIn">
                                    <c:if test="${post.picUrl != null && post.picUrl ne ''}">
                                        <img src="/getImage?picName=${post.picUrl}" alt="Image placeholder">
                                    </c:if>
